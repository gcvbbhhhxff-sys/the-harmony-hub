...
export function CheckoutForm({initialAddresses}:{initialAddresses:SavedAddress[]}) {
  ...
  const [consent,setConsent]=useState(false); const [phone,setPhone]=useState(""); const [otp,setOtp]=useState(""); const [identified,setIdentified]=useState(false);
