...
export function LoginForm() {
  ...
  return (
    <main className="min-h-screen grid place-items-center bg-[radial-gradient(circle_at_top,rgba(211,163,40,.18),transparent_34rem)] bg-[var(--color-secondary)] p-4">
      <Card className="w-full max-w-md rounded-3xl p-7 shadow-[0_24px_70px_rgba(0,0,0,.3)]">
        ...
        <div className="mt-6 grid gap-3">
          ...
          <Input
            ...
            onKeyDown={(event) => { if (event.key === "Enter") submit(); }}
          />
          <Button className="h-12 rounded-xl font-black" disabled={pending} onClick={submit}>
